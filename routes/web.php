...
Route::middleware('auth')->group(function () {
    ...
    Route::get(
    'savings-goals/{savingsGoal}/contributions/create',
    [SavingsContributionController::class, 'create']
)->name('savings-goals.contributions.create');

Route::post(
    'savings-goals/{savingsGoal}/contributions',
    [SavingsContributionController::class, 'store']
)->name('savings-goals.contributions.store');

Route::delete(
    'savings-contributions/{savingsContribution}',
    [SavingsContributionController::class, 'destroy']
